...
export const timeline: TimelineEntry[] = [
  ...
  { period: 'NOW', title: 'ARTIFICIAL INTELLIGENCE STUDIES', body: 'AI undergraduate, UAE.' },
  ...
  { period: 'NOW', title: 'AI & WEB PROJECTS', body: 'Hermes design-intelligence platform, book knowledge vaults.' },
...
export const skillGroups: SkillGroup[] = [
  { group: 'AI & BACKEND', items: ['Python', 'FastAPI', 'Pydantic', 'LangGraph', 'LangChain', 'Ollama', 'Qwen', 'Scikit-learn', 'PyTorch'] },
  { group: 'WEB', items: ['TypeScript', 'React', 'Next.js', 'Tailwind CSS', 'Three.js', 'REST APIs', 'SQL'] },
  { group: 'RESEARCH', items: ['Pandas', 'NumPy', 'Matplotlib', 'Experimental design', 'Model evaluation', 'Academic writing'] },
